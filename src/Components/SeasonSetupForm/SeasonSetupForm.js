...
export default class SSF extends React.Component {
  render() {
    return (
      <Form>
        <h3><strong>Season Setup</strong></h3>
        <FormGroup id="seasonName">
          <Label for="seasonName">What is your Season called?</Label>
          <Input type="text" name="seasonName" id="seasonName" placeholder="ie. current year" />
        </FormGroup>
        ...
        <FormGroup>
          <Label for="clubSeries">Does your club have multiple series in one season?</Label>
          <Input type="textarea" name="clubSeries" id="clubSeries" placeholder="ie. Spring, Summer, Fall. Please separate each series with a comma"/>
